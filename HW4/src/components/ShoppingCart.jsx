      ...
      <div className="fixed right-0 top-0 h-full w-full md:w-96 bg-gray-800 z-50 shadow-2xl flex flex-col">
        ...
        {items.length > 0 && (
          <div className="p-6 border-t border-gray-700 space-y-4">
            ...
            {error && (
              <div className="bg-red-900/50 border border-red-500 text-red-400 p-3 rounded-lg text-sm">
                {error}
              </div>
            )}
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="px-4 py-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 rounded-lg font-semibold hover:shadow-lg transition-all disabled:opacity-50"
              >
